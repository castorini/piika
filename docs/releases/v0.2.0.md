...
Minor release focused on making `pi-search` a clearer standalone validated extension contract, with `Piika` acting as the benchmark-backed validation loop around it.
...
- `Piika` consuming and benchmarking that contract correctly
